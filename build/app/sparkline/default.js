...
ReactDOM.render(
    React.createElement(EJ.Sparkline, {id: "sparkline2", 
...
ReactDOM.render(
    React.createElement(EJ.Sparkline, {id: "sparkline3", 
...
ReactDOM.render(
    React.createElement(EJ.Sparkline, {id: "sparkline4", 
...
ReactDOM.render(
    React.createElement(EJ.Sparkline, {id: "sparkline5", 
...
ReactDOM.render(
    React.createElement(EJ.Sparkline, {id: "sparkline6", 
...
ReactDOM.render(
    React.createElement(EJ.Sparkline, {id: "sparkline7", 
...
ReactDOM.render(
    React.createElement(EJ.Sparkline, {id: "sparkline8", 
