...
var pivot_dataset = [
 ...
 var relational_dataSource={    data: pivot_dataset,
                                rows: [
                                    {
                                        fieldName: "Country",
...
ReactDOM.render(
    React.createElement(EJ.PivotGauge, {id: "relational", 
	dataSource: relational_dataSource, 
    ...
    scales: pivotguage_scale
		  ...
		  document.getElementById('pivotgauge-relational')
);
