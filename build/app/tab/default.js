var DefaultTab = React.createClass({displayName: "DefaultTab",
    render: function () {
        return (
            React.createElement("div", {id: "tab_default"}, 
...
ReactDOM.render(React.createElement(DefaultTab, null), document.getElementById('tab-default'));