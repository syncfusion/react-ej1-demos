...
var FileExplorer = React.createClass({displayName: "FileExplorer",
    ...
    render: function () {
        return (
            React.createElement("div", {className: "content-container-fluid"}, 
                React.createElement("span", {className: "text"}, "Localization for de-DE Culture"), React.createElement("br", null), React.createElement("br", null), 
                    React.createElement("div", {className: "control"}, 
                React.createElement(EJ.FileExplorer, {id: "localization", ajaxDataType: ajaxDataType, ajaxAction: localServ, isResponsive: true, width: "100%", minWidth: "150px", fileTypes: "*.png, *.gif, *.jpg, *.jpeg, *.docx", path: path, locale: "de-DE", gridSettings: gridSettings}
                ), ","
            )
...
ReactDOM.render(React.createElement(FileExplorer, null), document.getElementById('fileexplorer-localization'));