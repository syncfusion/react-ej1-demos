...
var Treeview = React.createClass({displayName: "Treeview",
    ...
    render: function () {
        return (
                React.createElement(EJ.TreeView, {id: "treetemplate", template: "#treeTemplate", fields: fields}
                )   
            );
}
});
ReactDOM.render(React.createElement(Treeview, null), document.getElementById('treeview-template'));