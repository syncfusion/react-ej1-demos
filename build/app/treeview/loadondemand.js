...
var fields={id: "id", parentId: "pid", text: "name", hasChild: "hasChild", dataSource: localData};				   
ReactDOM.render(   
	React.createElement(EJ.TreeView, {id: "treeview", loadOnDemand: true, fields: fields}
  ),
	document.getElementById('treeview-loadondemand')
);
