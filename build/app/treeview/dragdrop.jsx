...
ReactDOM.render(   
	<EJ.TreeView fields={fields} allowDragAndDrop={true} width="200" allowDropChild={true} allowDropSibling={true} allowDragAndDropAcrossControl={true}>
  </EJ.TreeView>,
	document.getElementById('treeview-drag')
);
ReactDOM.render(   
	<EJ.TreeView fields={fields1} allowDragAndDrop={true} width="200" allowDropChild={true} allowDropSibling={true} allowDragAndDropAcrossControl={true}>
  </EJ.TreeView>,
