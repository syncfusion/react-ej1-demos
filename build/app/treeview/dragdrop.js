...
var localData1=[{ id: 1, name: " ASP.NET MVC Team", hasChild: true, expanded: true },
...
var fields={id: "id", parentId: "pid", text: "name", hasChild: "hasChild", dataSource: localData1, expanded: "expanded"};
var fields1={id: "id", parentId: "pid", text: "name", hasChild: "hasChild", dataSource: localData, expanded: "expanded"};

ReactDOM.render(   
	React.createElement(EJ.TreeView, {fields: fields, allowDragAndDrop: true, width: "200", allowDropChild: true, allowDropSibling: true, allowDragAndDropAcrossControl: true}
  ),
	document.getElementById('treeview-drag')
);
ReactDOM.render(   
	React.createElement(EJ.TreeView, {fields: fields1, allowDragAndDrop: true, width: "200", allowDropChild: true, allowDropSibling: true, allowDragAndDropAcrossControl: true}
  ),
	document.getElementById('treeview-drop')
);
