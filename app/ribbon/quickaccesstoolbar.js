...
React.createElement("ul", {id: "pasteSplit2"}, 
   React.createElement("li", null, React.createElement("a", null, "Paste"))
), 
   React.createElement(EJ.Ribbon, {id: "quickAccessToolbar", width: "100%", isResponsive: true, applicationTab: backstage2, create: createControl2, showQAT: true}, 
			  ...
			  React.createElement("group", {text: "Clipboard", alignType: "columns"}, 
                React.createElement("content", null, 
                    React.createElement("content", {"defaults-type": "splitbutton", "defaults-width": 60, "defaults-height": 70}, 
                       React.createElement("groups", null, 
                           React.createElement("group", {id: "paste", text: "Paste", quickAccessMode: "toolbar", "customTooltip-prefixIcon": "e-pastetip", "splitButtonSettings-contentType": "imageonly", "splitButtonSettings-prefixIcon": "e-icon e-ribbon e-ribbonpaste", "splitButtonSettings-targetID": "pasteSplit2", "splitButtonSettings-buttonMode": "dropdown", "splitButtonSettings-arrowPosition": "bottom", "splitButtonSettings-click": "executeAction"}
                           )
                        )
                      ), 
					 ...
					 React.createElement("group", {text: "Alignment", alignType: "rows"}, 
                        React.createElement("content", null, 
                           React.createElement("content", {"defaults-type": "button", "defaults-isBig": false}, 
                             React.createElement("groups", null, 
                                React.createElement("group", {id: "bullet", text: "Bullet Format", quickAccessMode: "toolbar", "buttonSettings-contentType": "imageonly", "buttonSettings-prefixIcon": "e-icon e-ribbon e-bullet", "buttonSettings-click": "executeAction"}), 
                                                    React.createElement("group", {id: "number", text: "Number Format", quickAccessMode: "toolbar", enableSeparator: true, "buttonSettings-contentType": "imageonly", "buttonSettings-prefixIcon": "e-icon e-ribbon e-numbericon", "buttonSettings-click": "executeAction"}), 
                                                    ...
                                                    React.createElement("group", {id: "sortascending", quickAccessMode: "toolbar", text: "Sort", enableSeparator: true, "buttonSettings-contentType": "imageonly", "buttonSettings-prefixIcon": "e-icon e-ribbon e-sort", "buttonSettings-click": "executeAction"}), 
