...
ReactDOM.render(
    <EJ.Spreadsheet allowFormulaBar={false} enableContextMenu={false} scrollSettings-width="100%" scrollSettings-height="100%" scrollSettings-isResponsive={true} showRibbon={false} sheets={sheets} loadComplete="loadComplete"></EJ.Spreadsheet>,
