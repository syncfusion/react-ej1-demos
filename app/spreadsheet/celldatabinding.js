...
var sheets=[{
                    rows: [
                        ...
                        },
                        {
                            cells: [
                                ...
                                { value: "=B2*C2", format: { type: "currency" } },
                                { value: "OUT OF STOCK" },
                        ...
                        },
                        {
                            cells: [
                                ...
                                { value: "=B3*C3", style: { "background-color": "#E5F3FF" }, format: { type: "currency" }},
                        ...
                        },
                    {
                        cells: [
                            ...
                            { value: "=B4*C4",format: { type: "currency" }},
                            { value: "IN STOCK" },
                            { value: "Amazon", hyperlink: { webAddr: "www.amazon.com" } }
                        ]
                    },
                    {
                        cells: [
                            ...
                            { value: "=B5*C5", style: { "background-color": "#E5F3FF" },format: { type: "currency" } },
                    ...
                    },
                    {
                        cells: [
                            ...
                            { value: "=B6*C6",format: { type: "currency" } },
                            { value: "IN STOCK" },
                    ...
                    },
                    {
                        cells: [
                            ...
                            { value: "20", format: { type: "currency" }, style: { "background-color": "#E5F3FF" } },
                            { value: "=B7*C7", style: { "background-color": "#E5F3FF" },format: { type: "currency" } },
                            { value: "OUT OF STOCK", style: { "background-color": "#E5F3FF" } },
                    ...
                    },
                    {
                        cells: [
                            ...
                            { value: "20" },
                            { value: "10", format: { type: "currency" } },
                            { value: "=B8*C8",format: { type: "currency" } },
                            { value: "IN STOCK" },
                    ...
                    },
                    {
                        cells: [
                            ...
                            { value: "=B9*C9", style: { "background-color": "#E5F3FF" },format: { type: "currency" } },
                            { value: "OUT OF STOCK", style: { "background-color": "#E5F3FF" } },
                            { value: "Alibaba", hyperlink: { webAddr: "www.alibaba.com" }, style: { "background-color": "#E5F3FF" } }
                        ]
                    },
                    {
                        cells: [
                            ...
                            { value: "=B10*C10",format: { type: "currency" } },
                            { value: "IN STOCK" },
                            { value: "Ebay", hyperlink: { webAddr: "www.ebay.com" } }
                        ]
                    },
                    {
                        cells: [
                            ...
                            { value: "10", format: { type: "currency" }, style: { "background-color": "#E5F3FF" } },
                            { value: "=B11*C11", style: { "background-color": "#E5F3FF" },format: { type: "currency" } },
                            { value: "OUT OF STOCK", style: { "background-color": "#E5F3FF" } },
                            { value: "Amazon", hyperlink: { webAddr: "www.amazon.com" }, style: { "background-color": "#E5F3FF" } }
                        ]
                    },
                    {
                        ...
                        cells: [
                            ...
                            { value: "=Sum(D2:D11)", style: { "font-weight": "bold", "color": "#FFFFFF", "background-color": "#428bca" },format: { type: "currency" } },
                            { style: { "background-color": "#428bca" } },
                            { style: { "background-color": "#428bca" } }
                        ]
                    }
...
ReactDOM.render(
    React.createElement(EJ.Spreadsheet, {allowFormulaBar: false, "scrollSettings-width": "100%", "scrollSettings-height": "100%", "scrollSettings-isResponsive": true, showRibbon: false, sheets: sheets, loadComplete: "loadComplete", userName: "Comments"}),
    document.getElementById('spreadsheet-celldatabinding')
);