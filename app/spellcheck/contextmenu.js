...
var SpellMenu = React.createClass({displayName: "SpellMenu",    
    ...
    render: function () {
        return (
        React.createElement("div", {id: "spell_menu"}, 
            React.createElement(EJ.SpellCheck, {id: "SpellCheck2", "dictionarySettings-dictionaryUrl": "//js.syncfusion.com/demos/ejservices/api/SpellCheck/CheckWords", "dictionarySettings-customDictionaryUrl": "//js.syncfusion.com/demos/ejservices/api/SpellCheck/AddToDictionary"}, 
            ...
            React.createElement(EJ.Button, {id: "btnCheck", type: "button", height: 30, text: "Spell Check", click: this.checkInTarget}
            )
        )
        );
    }
...
ReactDOM.render(React.createElement(SpellMenu, null), document.getElementById('contextmenu'));