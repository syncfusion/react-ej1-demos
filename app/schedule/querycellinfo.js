...
var ScheduleCellFormat = React.createClass({displayName: "ScheduleCellFormat",
       check: function (args) {
...
ReactDOM.render(React.createElement(ScheduleCellFormat, null), document.getElementById('schedule-cellformatting'));
