...
ReactDOM.render(
    <EJ.Grid dataSource={window.gridData} allowPaging={true} allowScrolling={true} scrollSettings={scrollSettings} showSummary={true} summaryRows={summaryRows} allowSorting={true} allowGrouping={true} groupSettings={groupSettings} columns={columns} >
    </EJ.Grid>,
