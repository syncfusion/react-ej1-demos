...
ReactDOM.render(
    <EJ.Tab width="100%">
        <ul>
            <li><a href="#India">India</a><span className="flagsimage sprite-India"></span></li>
            <li><a href="#Australia">Australia</a><span className="flagsimage sprite-Australia"></span></li>
            <li><a href="#USA">United States</a><span className="flagsimage sprite-USA"></span></li>
            <li><a href="#France">France</a><span className="flagsimage sprite-France"></span></li>
        </ul>
            <div id="India">
