...
var Main = createReactClass({
  ...
  render: function () {
    return (
      ...
      <div id="reactRoot" className="holder e-remove">
	      <div id="ej2popup" className= "e-ej2popup">
			<div className="e-popup-close">
				<button id="popupclose" className="float-right ejbutton" onClick={this.handleClick} type="button">
				<span className="e-btn-span">
                    <span className="e-icon ej2popupclose"> </span>			
				</span>
				</button>
			</div>
			<table className="e-popup-table">
				<tr>
					<td className="e-popup-td">
						<div className="e-popup-content">
							<table className="e-content-table">
								<tr>
									<td className="e-content-td1">
										<div className="e-popup-first">Take a look at our next generation</div>
									</td>
									<td className="e-content-td2">
										<div className="e-popup-second">JavaScript Library</div>
									</td>
								</tr>
							</table>
						</div>
					...
					<td className="e-popup-td">
						<div className="e-popup-more">
							<a href="//ej2.syncfusion.com/home/react.html?utm_source=ej1&utm_medium=banner&utm_campaign=migrate" className="anchorclass" target="_blank">
								<button id="learnmore" className="float-right ejbutton e-button e-js e-ntouch e-btn-normal learnmore e-btn e-select e-widget e-txt e-corner" title="Essential JS 2" type="button" onClick={this.handleClick} >LEARN MORE</button>
							</a>
						</div>
					</td>
				</tr>
          ...
          <div className="e-header header">
              <span className="e-iconlogo-synclogo" id="butdrawer"> </span>
            <div id="controlMenuDrawer" className="menuIcon drawericon e-icon"></div>

            <div className="control_title title" id="controlHeader"></div>
            <span onClick={this.onTargetDialog} title="Code Preview" className="source-code-icon"></span>
                <EJ.Menu id="themeswitcher" fields={window.themeMenu} isResponsive={false} openOnClick={true} cssClass="e-custom-theme" click={this.themeSwitch}>
                  </EJ.Menu>
				  <div className="ej2option">
                    <a href="//ej2.syncfusion.com/home/react.html?utm_source=ej1&utm_medium=referral&utm_campaign=migrate" className="anchorclass" target="_blank">
                       <button id="ej2button" className="float-right ejbutton e-button e-js e-ntouch e-btn-normal ej2button e-btn e-select e-widget e-corner" title="Essential JS 2" type="button">
					     <span className="e-btn-span">
						 <span className="e-icon ej2button-logo"></span>
						 <span className="e-btntxt">ESSENTIAL JS 2</span>
						 </span>
					   </button>
                    </a>
                  </div>
        ...
        <div className="drawerWrapper">
          ...
          <EJ.Dialog id="sourcecodeDialog" isResponsive={true} enableModal={true} containment="#targetdialog" width={600} height={500} title="Code Preview" allowDraggable={false} enableResize={false} showOnInit={false} >
            <EJ.Tab id="tab" width="100%" height="100%" itemActive={this.onitemActive}>
              <ul>
                <li><a href="#htmlsource">HTML</a></li>
                <li><a href="#jssource">JSX</a></li>
              </ul>
              <div id="htmlsource">
          ...
          <EJ.NavigationDrawer id="navpane" targetId="controlMenuDrawer" contentId="content_container" type="overlay"
            enableListView={true} position="normal" isPaneOpen={true} ajaxSuccess={this.onAjaxSuccess}>
            <div id="navContainer">
             
              <div id="searchContainer">
                <EJ.Autocomplete id="searchBox" dataSource={window.samples} fields={searchFields}
                  width="100%" height={35} filterType="contains" select={this.searchSelection}
                  watermarkText="Search a control" showPopupButton={true} focusOut={this.autoFocusOut} close={this.clearInput}></EJ.Autocomplete>
              </div>
              <div id="ejAccordion">
                <EJ.ListView id="controllist" dataSource={window.samples} mouseUp={this.handlerSelection}
