...
<ul id="pasteSplit1">
  ...
  <EJ.Ribbon id="resizeRibbon" width="100%" isResponsive={true} applicationTab={backstage1} create={createControl1}>
      <tabs>
					 ...
					 <group text="Alignment" alignType="rows">
                        <content>
                           <content defaults-type="button" defaults-isBig={false}>
                             <groups>
                                <group id="bullet" text="Bullet Format" buttonSettings-contentType="imageonly" buttonSettings-prefixIcon="e-icon e-ribbon e-bullet" buttonSettings-click="executeAction"></group>
                                                    <group id="number" text="Number Format" enableSeparator={true} buttonSettings-contentType="imageonly" buttonSettings-prefixIcon="e-icon e-ribbon e-numbericon" buttonSettings-click="executeAction"></group>
                                                    ...
                                                    <group id="sortascending" text="Sort" enableSeparator={true} buttonSettings-contentType="imageonly" buttonSettings-prefixIcon="e-icon e-ribbon e-sort" buttonSettings-click="executeAction"></group>
