...
ReactDOM.render(
    <EJ.Spreadsheet allowFormulaBar={false} scrollSettings-width="100%" scrollSettings-height="100%" scrollSettings-isResponsive={true} showRibbon={false} sheets={sheets} loadComplete="loadComplete"  userName="Comments"></EJ.Spreadsheet>,
